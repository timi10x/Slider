...
class CustomSeekBar(context: Context, attrs: AttributeSet): AppCompatSeekBar(context, attrs), SeekBar.OnSeekBarChangeListener {

    interface OnPreviewTextChangeListener {
        fun onPreviewTextChanged(seekBar: CustomSeekBar, progress: Int): String
    }
    ...
    init {
        ...
        val parent = View.inflate(context, R.layout.tooltip, null)
